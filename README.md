# _Taproom Two-Day Assignment: Kegzone!_

#### _This application allows the user to track the kegs in their beer garden._

#### By _**James Lannon and Andrew Dalton**_
...
Copyright (c) 2016 **_{James Lannon, Andrew Dalton, Epicodus}_**
